#[allow(dead_code)]
pub const EXAMPLE_RULLS:&str = r"px{a<2006:qkq,m>2090:A,rfg}
pv{a>1716:R,A}
lnx{m>1548:A,A}
...
#[allow(dead_code)]
pub const EXAMPLE_PARTS:&str = r"{x=787,m=2655,a=1222,s=2876}
...
#[allow(dead_code)]
pub const INPUT_RULLS:&str = r"fmz{x<2152:R,s>3520:A,a<3391:A,A}
...
#[allow(dead_code)]
pub const INPUT_PARTS:&str = r"{x=53,m=706,a=908,s=10}
